...
import { CONST_ID_LOGIN_USERNAME, CONST_LOGIN_USERNAME, CONST_ID_LOGIN_PASSWORD, CONST_LOGIN_PASSWORD, CONST_ID_BUTTON_LOGIN } from '../lib/constants.js';
...
export async function LOGIN(page) {
    try {
        ...
        await page.fill(CONST_ID_LOGIN_USERNAME, CONST_LOGIN_USERNAME);
        
        // Type the password into the input field with the given constant ID
        await page.fill(CONST_ID_LOGIN_PASSWORD, CONST_LOGIN_PASSWORD);
